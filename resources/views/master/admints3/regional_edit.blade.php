...
<form action="{{ route('regional-area-process') }}" enctype="multipart/form-data" method="post" accept-charset="utf-8">
{{ csrf_field() }}
...
<div class="form-group row">
	...
	<div class="col-sm-9">
		<div class="form-group pull-right btn-group">
			...
			<a href="{{ route('regional') }}" class="btn btn-danger">Kembali</a>
		</div>
	</div>
